...
public class ManagerReservationListActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.activity_maneger_timeline_card, container, false);
    ...
    public static ManagerReservationListActivity newInstance(int sectionNumber) {
        ManagerReservationListActivity fragment = new ManagerReservationListActivity();
